...
- When assigning `BET_THRESHOLD` take into consideration that fees (at the time of writing this guide) are in the range of 0.02 xDAI. You can query the fees via the [Omen subgraph](https://omen.subgraph.autonolas.tech) (GraphQL endpoint). We urge you to keep an eye on these fees, as they might vary.
