...
stateDiagram-v2
    ...
    BenchmarkingRandomnessRound --> BenchmarkingRandomnessRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    BetPlacementRound --> BetPlacementRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    BlacklistingRound --> CallCheckpointRound: <center>MOCK_TX<br />DONE</center>
    BlacklistingRound --> ImpossibleRound: <center>FETCH_ERROR<br />NONE</center>
    BlacklistingRound --> BlacklistingRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    CallCheckpointRound --> CallCheckpointRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    ChatuiLoadRound --> ChatuiLoadRound: <center>ROUND_TIMEOUT<br />FAIL<br />NO_MAJORITY<br />NONE</center>
    ...
    CheckBenchmarkingModeRound --> CheckBenchmarkingModeRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    CheckStopTradingRound --> RandomnessRound: <center>REVIEW_BETS<br />DONE</center>
    CheckStopTradingRound --> CheckStopTradingRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY<br />NONE</center>
    ...
    DecisionReceiveRound --> BlacklistingRound: <center>TIE<br />UNPROFITABLE<br />MECH_RESPONSE_ERROR</center>
    DecisionReceiveRound --> DecisionReceiveRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    DecisionRequestRound --> DecisionRequestRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    FetchPerformanceDataRound --> UpdateAchievementsRound: <center>FAIL<br />ROUND_TIMEOUT<br />DONE</center>
    ...
    MechInformationRound --> MechInformationRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    MechPurchaseSubscriptionRound --> PreTxSettlementRound: <center>DONE</center>
    MechPurchaseSubscriptionRound --> MechPurchaseSubscriptionRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY<br />NONE</center>
    ...
    MechRequestRound --> MechRequestRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    MechVersionDetectionRound --> MechVersionDetectionRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    MechVersionDetectionRound --> CheckBenchmarkingModeRound: <center>NO_MARKETPLACE<br />V1</center>
    ...
    OmenWithdrawRound --> ResetAndPauseRound: <center>WITHDRAWAL_ROUND_TIMEOUT<br />WITHDRAWAL_DONE</center>
    PolymarketBetPlacementRound --> CallCheckpointRound: <center>MOCK_TX<br />BET_PLACEMENT_DONE<br />DONE</center>
    PolymarketBetPlacementRound --> PolymarketBetPlacementRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY<br />BET_PLACEMENT_FAILED</center>
    ...
    PolymarketFetchMarketRound --> PolymarketFetchMarketRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    PolymarketPostSetApprovalRound --> PolymarketPostSetApprovalRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    PolymarketRedeemRound --> CheckStopTradingRound: <center>MOCK_TX<br />NO_REDEEMING<br />DONE</center>
    ...
    PolymarketSetApprovalRound --> PolymarketSetApprovalRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    PolymarketSwapUsdcRound --> PolymarketSwapUsdcRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    PolymarketWithdrawRound --> ResetAndPauseRound: <center>WITHDRAWAL_ROUND_TIMEOUT<br />WITHDRAWAL_DONE</center>
    PolymarketWrapCollateralRound --> FetchMarketsRouterRound: <center>MOCK_TX<br />NONE<br />DONE</center>
    PolymarketWrapCollateralRound --> PolymarketWrapCollateralRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    PostBetUpdateRound --> PostBetUpdateRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY<br />NONE</center>
    PostTxSettlementRound --> PostBetUpdateRound: <center>SELL_OUTCOME_TOKENS_DONE<br />BET_PLACEMENT_DONE</center>
    ...
    RandomnessRound --> RandomnessRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    RandomnessTransactionSubmissionRound --> SelectKeeperTransactionSubmissionARound: <center>DONE</center>
    RandomnessTransactionSubmissionRound --> RandomnessTransactionSubmissionRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY<br />NONE</center>
    ...
    ResetRound --> HandleFailedTxRound: <center>RESET_TIMEOUT<br />NO_MAJORITY</center>
    ...
    SamplingRound --> SamplingRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY<br />NEW_SIMULATED_RESAMPLE</center>
    ...
    SellOutcomeTokensRound --> SellOutcomeTokensRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
    ...
    ToolSelectionRound --> ToolSelectionRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY<br />NONE</center>
    UpdateAchievementsRound --> ChatuiLoadRound: <center>FAIL<br />ROUND_TIMEOUT<br />DONE</center>
    ...
    UpdateBetsRound --> UpdateBetsRound: <center>ROUND_TIMEOUT<br />NO_MAJORITY</center>
