...
from packages.valory.skills.market_manager_abci.tests.test_models import MARKET_MANAGER_PARAMS
from packages.valory.skills.trader_abci.models import RandomnessApi, TraderParams, SharedState, MARGIN
...
DUMMY_DECISION_MAKER_PARAMS = {
            ...
            'file_hash_to_strategies_json': [['{"k1": "key2"}', '{"b1": "b2"}'], ['{"v1": "v2"}', '{"b1": "b2"}']],
            'strategies_kwargs': [['{"k1": "key2"}', '{"b1": "b2"}'], ['{"v1": "v2"}', '{"b1": "b2"}']],
            'use_subgraph_for_redeeming': True,
            'use_nevermined': False,
            'rpc_sleep_time': 2,
            'mech_to_subscription_params': [['{"k1": "key2"}', '{"b1": "b2"}'], ['{"v1": "v2"}', '{"b1": "b2"}']],
...
class TestTraderParams:
    ...
    def test_initialization(self) -> None:
        """Test initialization."""
        TraderParams(**BASE_DUMMY_PARAMS,
                     **DUMMY_DECISION_MAKER_PARAMS,
